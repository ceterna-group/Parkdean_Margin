({
  ...
  loadApp: function($C, $E, $H) {
    /*var pitches = [
      { Area_Name__c: 'Ash Mews', Pitch_Number__c: '0030', Pitch_Type__c: 'Standard', Zone_Code__c: '1', Pitch_Status__c: 'Vacant' },
      { Area_Name__c: 'Ash Mews', Pitch_Number__c: '0023', Pitch_Type__c: 'Standard', Zone_Code__c: '1', Pitch_Status__c: 'Vacant' },
      { Area_Name__c: 'Ash Mews', Pitch_Number__c: '0047', Pitch_Type__c: 'Premium', Zone_Code__c: '2', Pitch_Status__c: 'Vacant' },
      { Area_Name__c: 'Beech Field', Pitch_Number__c: '0078', Pitch_Type__c: 'Standard', Zone_Code__c: '2', Pitch_Status__c: 'Vacant' },
      { Area_Name__c: 'Beech Field', Pitch_Number__c: '0031', Pitch_Type__c: 'Standard', Zone_Code__c: '2', Pitch_Status__c: 'Vacant' },
      { Area_Name__c: 'Cedar Walk', Pitch_Number__c: '0082', Pitch_Type__c: 'Standard', Zone_Code__c: '3', Pitch_Status__c: 'Vacant' },
    ];
